...
<head>
    ...
    <title>Database Management Lectures - EduLearn</title>
...
<body>
    ...
    <section class="lectures-section">
        <div class="lectures-header">
            ...
            <p>Master SQL, MySQL, Oracle, database design, normalization, and fundamental database concepts.</p>
        </div>
        ...
        <div class="video-container">
            ...
            <div class="video-card">
                ...
                <div class="video-info">
                    <h3>Lecture 1: Intro to Databases</h3>
                    <p>Concepts of RDBMS, NoSQL, data models, and why we need databases in software systems.</p>
            ...
            <div class="video-card">
                ...
                <div class="video-info">
                    <h3>Lecture 2: SQL Basics</h3>
                    <p>Learn core SQL commands including SELECT, INSERT, UPDATE, and DELETE queries.</p>
                    <div class="video-meta">
                        <span><span style="font-size:16px; margin-right:5px">⏱</span> 55 mins</span>
                        <span class="module-badge">SQL</span>
                    </div>
                </div>
            </div>
            ...
            <div class="video-card">
                ...
                <div class="video-info">
                    <h3>Lecture 3: Database Design</h3>
                    <p>Understand Entity Relationship (ER) Diagrams, primary/foreign keys, and creating schemas.</p>
                    <div class="video-meta">
            ...
            <div class="video-card">
                <div class="video-wrapper">
                    <video controls poster="https://images.pexels.com/photos/1181298/pexels-photo-1181298.jpeg?auto=compress&cs=tinysrgb&w=600">
                        <source src="https://www.w3schools.com/html/mov_bbb.mp4" type="video/mp4">
                        Your browser does not support HTML video.
                    </video>
                </div>
                <div class="video-info">
                    <h3>Lecture 4: Normalization</h3>
                    <p>Learn about 1NF, 2NF, 3NF, BCNF, and how to reduce data redundancy in your databases.</p>
                    <div class="video-meta">
            ...
            <div class="video-card">
                ...
                <div class="video-info">
                    <h3>Lecture 5: Joins & Advanced Queries</h3>
                    <p>Master INNER JOIN, LEFT JOIN, data aggregations, grouping, and complex subqueries.</p>
                    <div class="video-meta">
                        <span><span style="font-size:16px; margin-right:5px">⏱</span> 65 mins</span>
                        <span class="module-badge">Advanced SQL</span>
                    </div>
                </div>
            </div>
            ...
            <div class="video-card">
                <div class="video-wrapper">
                    <video controls poster="https://images.pexels.com/photos/1181359/pexels-photo-1181359.jpeg?auto=compress&cs=tinysrgb&w=600">
                        <source src="https://www.w3schools.com/html/mov_bbb.mp4" type="video/mp4">
                        Your browser does not support HTML video.
                    </video>
                </div>
                <div class="video-info">
                    <h3>Lecture 6: NoSQL Databases</h3>
                    <p>Introduction to document-oriented storage like MongoDB, JSON structures, and scalability.</p>
                    <div class="video-meta">
                        <span><span style="font-size:16px; margin-right:5px">⏱</span> 45 mins</span>
                        <span class="module-badge">NoSQL</span>
                    </div>
                </div>
            </div>
