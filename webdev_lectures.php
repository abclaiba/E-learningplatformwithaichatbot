...
<head>
    ...
    <title>Web Development Lectures - EduLearn</title>
...
<body>
    ...
    <section class="lectures-section">
        <div class="lectures-header">
            ...
            <p>Master HTML, CSS, JavaScript, and build modern responsive websites with our comprehensive lecture series.</p>
        </div>
        ...
        <div class="video-container">
            ...
            <div class="video-card">
                ...
                <div class="video-info">
                    <h3>Lecture 1: Introduction to HTML</h3>
                    <p>Learn the basics of HTML, the foundational language of the web. We cover tags, elements, and page structure.</p>
            ...
            <div class="video-card">
                ...
                <div class="video-info">
                    <h3>Lecture 2: CSS Styling Fundamentals</h3>
                    <p>Discover how to style your HTML elements using CSS. Colors, fonts, margins, and the box model explained.</p>
                    <div class="video-meta">
            ...
            <div class="video-card">
                ...
                <div class="video-info">
                    <h3>Lecture 3: JavaScript Basics</h3>
                    <p>Make your websites interactive with JavaScript. Variables, functions, and DOM manipulation basics.</p>
                    <div class="video-meta">
                        <span><span style="font-size:16px; margin-right:5px">⏱</span> 60 mins</span>
                        <span class="module-badge">Interactivity</span>
                    </div>
                </div>
            </div>
            ...
            <div class="video-card">
                ...
                <div class="video-info">
                    <h3>Lecture 4: Responsive Web Design</h3>
                    <p>Learn how to build layouts that adapt to any screen size using Flexbox, CSS Grid, and media queries.</p>
                    <div class="video-meta">
                        <span><span style="font-size:16px; margin-right:5px">⏱</span> 50 mins</span>
                        <span class="module-badge">Advanced CSS</span>
                    </div>
                </div>
            </div>
            ...
            <div class="video-card">
                ...
                <div class="video-info">
                    <h3>Lecture 5: Frontend Frameworks Overview</h3>
                    <p>An introduction to modern frontend frameworks like React, Vue, and Angular and why we use them.</p>
                    <div class="video-meta">
            ...
            <div class="video-card">
                ...
                <div class="video-info">
                    <h3>Lecture 6: Building a Complete Project</h3>
                    <p>Follow along as we build a complete, responsive landing page from scratch using HTML, CSS, and JS.</p>
                    <div class="video-meta">
                        <span><span style="font-size:16px; margin-right:5px">⏱</span> 90 mins</span>
                        <span class="module-badge">Project</span>
                    </div>
                </div>
            </div>
