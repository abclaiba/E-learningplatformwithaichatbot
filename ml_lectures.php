...
<head>
    ...
    <title>Machine Learning Lectures - EduLearn</title>
...
<body>
    ...
    <section class="lectures-section">
        <div class="lectures-header">
            ...
            <p>Learn supervised, unsupervised learning, and ML algorithms. Build models that learn from data.</p>
        </div>
        ...
        <div class="video-container">
            ...
            <div class="video-card">
                ...
                <div class="video-info">
                    <h3>Lecture 1: Intro to Machine Learning</h3>
                    <p>What is Machine Learning? Understand the basics of supervised, unsupervised, and reinforcement learning.</p>
            ...
            <div class="video-card">
                ...
                <div class="video-info">
                    <h3>Lecture 2: Linear Regression</h3>
                    <p>Learn about simple and multiple linear regression, cost functions, and gradient descent algorithms.</p>
                    <div class="video-meta">
                        <span><span style="font-size:16px; margin-right:5px">⏱</span> 50 mins</span>
                        <span class="module-badge">Supervised</span>
                    </div>
                </div>
            </div>
            ...
            <div class="video-card">
                ...
                <div class="video-info">
                    <h3>Lecture 3: Logistic Regression</h3>
                    <p>Understand how to classify data using logistic regression and evaluate your model's performance.</p>
                    <div class="video-meta">
                        <span><span style="font-size:16px; margin-right:5px">⏱</span> 55 mins</span>
                        <span class="module-badge">Classification</span>
                    </div>
                </div>
            </div>
            ...
            <div class="video-card">
                ...
                <div class="video-info">
                    <h3>Lecture 4: Decision Trees & Forests</h3>
                    <p>Explore tree-based models, how they split data, and the power of ensemble learning with random forests.</p>
                    <div class="video-meta">
                        <span><span style="font-size:16px; margin-right:5px">⏱</span> 60 mins</span>
                        <span class="module-badge">Algorithms</span>
                    </div>
                </div>
            </div>
            ...
            <div class="video-card">
                ...
                <div class="video-info">
                    <h3>Lecture 5: K-Means Clustering</h3>
                    <p>Dive into unsupervised learning with k-means clustering to discover hidden groups in unlabelled data.</p>
                    <div class="video-meta">
                        <span><span style="font-size:16px; margin-right:5px">⏱</span> 50 mins</span>
                        <span class="module-badge">Unsupervised</span>
                    </div>
                </div>
            </div>
            ...
            <div class="video-card">
                ...
                <div class="video-info">
                    <h3>Lecture 6: Support Vector Machines</h3>
                    <p>Learn about hyperplanes, margin maximization, and kernel tricks for complex classification tasks.</p>
                    <div class="video-meta">
